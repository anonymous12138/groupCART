...
def get_counts(test_df, y_pred, cm,  biased_col, metric='aod'):
...
def measure_final_score(test_df,y_pred, cm, biased_col, metric):
    df1 = copy.deepcopy(test_df)
    return get_counts(df1, y_pred, cm, biased_col, metric=metric)
